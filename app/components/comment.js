   ...
   */
   handleLikeClick(clickEvent) {
     ...
     if (clickEvent.button === 0) {
       ...
       if (this.didUserLike()) {
         // User clicked 'unlike' button.  this.props.key
         unlikeComment(this.props.feedItemKey, this.props.commentIndex, 4, callbackFunction);
       } else {
         // User clicked 'like' button.
         likeComment(this.props.feedItemKey, this.props.commentIndex, 4, callbackFunction);
       }
     }
   }
      ...
      <div>
        ...
        <div className="media-body">
          <Link to={"/profile/" + this.props.author._id}>
            {this.props.author.fullName} </Link>
            {this.props.children}
          <br />
